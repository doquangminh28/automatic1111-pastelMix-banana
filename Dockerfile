...
ARG MODEL_URL='https://huggingface.co/andite/pastel-mix/resolve/main/pastelmix-better-vae-fp16.safetensors'
...
CMD ["python", "server.py", "--xformers", "--disable-safe-unpickle", "--no-hashing", "--listen", "--port", "8000", "--no-half"]
